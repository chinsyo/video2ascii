...
def text2png(text, fullpath, color = "#000", bgcolor = "#FFF", fontfullpath = None, fontsize = 13, leftpadding = 3, rightpadding = 3, width = 800):
	REPLACEMENT_CHARACTER = u'\uFFFD'
	NEWLINE_REPLACEMENT_STRING = ' ' + REPLACEMENT_CHARACTER + ' '

	#prepare linkback
	linkback = "created via http://ourdomain.com"
	fontlinkback = ImageFont.truetype('font.ttf', 9)
	...
	line_height = font.getsize(text)[1] - 11
...
if __name__ == "__main__":
	...
	text_filename = text_file_path.split('.')[0]
	with open(text_file_path, 'r') as f:
		text = f.read()
		text2png(text, text_filename + '.png', fontfullpath = "font.ttf")
